	...
	class DTTacticLevelZero : TacticComponent
	{
		...
		protected override void TickOccasionally()
		{
			...
			else if (base.AreFormationsCreated && this.tickCounter == 0)
			{
				...
				DecisionIsAttacker decisionIsArcherAttacker = new DecisionIsAttacker(this._mainInfantry, archerCharge, archerCharge);

				DecisionIsFormationNotNull decisionArchersNotNull = new DecisionIsFormationNotNull(this._mainInfantry, decisionIsArcherAttacker, archerDontExist);
