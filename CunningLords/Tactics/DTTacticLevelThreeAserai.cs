...
{
    class DTTacticLevelThreeAserai : TacticComponent
    {
		...
		public DTTacticLevelThreeAserai(Team team) : base(team)
		{
		...
		protected override void TickOccasionally()
		{
			...
			{
				//InformationManager.DisplayMessage(new InformationMessage("Level 3 Aserai"));
